...
class Mongolia(Country):
    def __init__(self):
        super().__init__("Монголия",3400948,0,0.45,[
            ...
            [579,194],[568,191],[563,196],[558,196]
        ])
...
class China(Country):
    def __init__(self):
        super().__init__("Китай",1412000000, 0, 0.85,[
            ...
            [555,209],[551,201],[542,139],[534,209],[532,215],[522,220],[528,230],[531,238],[544,246],
...
class North_America(Country):
    def __init__(self):
        super().__init__("Северная Америка", 579000000, 0, 0.75, [
            [231,284],[227,269],[219,266],[221,258],[212,262],[202,261],[201,246],[215,243],[227,243],[231,253],
            [226,258],[246,265],[268,266],[247,256],[232,241],[242,229],[250,217],[284,202],[278,189],[264,168],
            [260,161],[270,150],[257,140],[240,124],[235,119],[238,108],[266,88],[234,86],[204,95],[189,102],[177,104],
            [154,113],[153,122],[145,137],[133,140],[90,133],[73,142],[80,149],[70,153],[82,155],[76,162],[72,168],
...
class Greenland(Country):
    def __init__(self):
        super().__init__("Гренландия",57000,0,0.55,[
            [360,93],[345,91],[334,91],[312,83],[297,86],[272,91],[259,98],[262,102],[248,106],[256,116],
            [271,115],[281,138],[287,141],[283,147],[293,167],[301,167],[308,155],[317,150],[323,145],[336,142],
...
class Xynta(Country):
    def __init__(self):
        super().__init__("Хунта",1000000000,0,0.5,[
            [468,223],[455,243],[451,243],[463,266],[463,273],[495,256],[488,251],[479,251],[473,241],[476,238],
            [489,248],[507,250],[514,258],[520,258],[529,283],[533,281],[534,269],[548,257],[556,256],[560,269],
            [566,266],[567,284],[572,290],[570,293],[563,288],[560,290],[563,288],[560,290],[571,305],[584,314],
            [613,316],[613,319],[621,314],[598,314],[583,311],[580,306],[584,303],[575,302],[577,290],[570,285],
            [573,257],[580,281],[586,276],[587,270],[580,262],[586,257],[579,252],[572,257],[566,252],[568,245],
            [559,241],[544,245],[531,238],[531,238],[531,232],[522,222],[507,217],[494,207],[487,208],[487,214],
